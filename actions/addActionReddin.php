				...
				<div class="modal-body">
					<div class="form-row">
						...
						<div class="form-group col-md-12 text-center">
							...
							<input type="text" class="form-control" name="fecha" style="text-align:center;" required="" readonly value="<?php setlocale(LC_TIME, "es_MX.UTF-8");
																																		echo strftime("%d de %B del %Y"); ?>">
							<input type="text" name="mes_reg" hidden value="<?php setlocale(LC_TIME, "es_MX.UTF-8");
																			echo strftime("%B"); ?>">
							<input type="text" name="year_reg" hidden value="<?php setlocale(LC_TIME, "es_MX.UTF-8");
																				echo strftime("%Y"); ?>">
						</div>
					</div>
					<div class="form-row">
