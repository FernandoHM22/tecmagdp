...
$sql_autoevaluacion = mysqli_query($conn, "SELECT oportunidad COLLATE utf8_general_ci AS autoevaluacion  FROM t_oportunidades WHERE no_reloj = '$no_reloj'
UNION ALL 
SELECT fortaleza AS autoevaluacion FROM t_fortalezas WHERE no_reloj = '$no_reloj'");
...
if (mysqli_fetch_row($sql_ficha_talento) > 0) {
  $buscar = mysqli_query($conn, "SELECT * FROM registrogdp Reg INNER JOIN t_fichatalento ficha WHERE Reg.no_reloj = '$no_reloj' AND Reg.no_reloj = ficha.reloj_colaborador") or die(mysqli_error($conn));
  $insertar = false;
...
<body id="page-top">
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top"> <a class="navbar-brand mr-1" href="myinfoSup.php">GDP</a>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?php if ($autoevaluacionRegistrada == '1' && $fichaTalentoRegistrada == '1') {
                              ...
                              echo "disabled";
                            } ?>" href="colaboradoresSup.php"> <i class="fas fa-users"></i> <span>Mis Colaboradores</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if ($autoevaluacionRegistrada == '1' && $fichaTalentoRegistrada == '1') {
                              echo "enable";
                              ...
                              echo "disabled";
                            } ?>" href="objetivosSup.php"> <i class="fas fa-fw fa-bullseye"></i> <span>Mis Objetivos</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if ($autoevaluacionRegistrada == '1' && $fichaTalentoRegistrada == '1') {
                              echo "enable";
                              ...
                              echo "disabled";
                            } ?>" href="planeacionSup.php"> <i class="fas fa-fw fa-chart-area"></i> <span>Plan de Desarrollo</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link <?php if ($autoevaluacionRegistrada == '1' && $fichaTalentoRegistrada == '1') {
                              echo "enable";
                ...
                <div class="tab-pane active" role="tabpanel" id="step1">
                  <div class="container-perfil">
                      ...
                      <div class="col-md-8">
                        <div class="row pl-2 sombras">
                          ...
                          <div class="col-md-6 seccionLaboral pt-5 pb-3">
                            ...
                            <form>
                              <div class="form-group row">
                                <label for="input_depto" class="col-sm-3 col-form-label">Correo</label>
                                <div class="col-sm-9">
                                  <input type="text" disabled id="input_correo" class="form-control form-control-sm campoDeshabilitado" value="<?= $correo ?>">
                                </div>
                              </div>
                              <div class="form-group row">
                    ...
                    <div class="row pl-2 pr-2 pt-1 sombras">
                      ...
                      <div class="col-md-4 seccionExperiencia pt-2 pb-3">
  ...
  <script>
    $(document).ready(function() {
      ...
      if (autoevaluacion != '1' && fichaTalento != '1') {
        Swal.fire({
          ...
          html: '<div class="alertaFichaTalentoSW">Menú GDP deshabilitado, para poder navegar debes actualizar tu ficha de talento y llenar autoevaluación <br> ' +
            ...
            'Para realizar Autoevaluación debes dar click en este icono <img class="imgAutoEvaluacion" src="../img/autoevaluacion.png"></div>',
      ...
      $('.btnEditarInfo').on('click', function(e) {
        ...
        $('.btnEditarImagen').attr('hidden', true);
      ...
      function cancelar() {
        ...
        $('.btnEditarImagen').attr('hidden', false);
