...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="sidebar navbar-nav">
      <li class="nav-item ">
        <a class="nav-link" href="myinfoSup.php"><i class="fas fa-chalkboard-teacher"></i> <span>Escritorio</span></a>
      </li>
      <li class="nav-item">
      ...
      ?>
        ...
        <li class="nav-item">
          <a class="nav-link" href="../control/reportPlan"><i class="fas fa-users"></i> <span>Reporte Personal</span></a>
        </li>
        <li class="nav-item">
    ...
    <div class="modal fade" id="modalBorrar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Borrar Nivel de Ingles</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">¿Deseas borrar registro?</div>
          <div class="modal-footer">
            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
            <a class="btn btn-danger" href="inglesSup.php?borrarIngles=<?php echo $idIngles ?>">Borrar</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <script>
      ...
      $('#modalActualizar').on('show.bs.modal', function(event) {
        ...
        var modal = $(this);
        var dataString = 'id_ingles=' + recipient;

        $.ajax({
          type: "GET",
          url: "actions/editarIngles.php",
          data: dataString,
          cache: false,
