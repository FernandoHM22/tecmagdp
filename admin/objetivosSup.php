  ...
  <div class="container-fluid">
    ...
    <div class="tab-content" id="myTabContent">
      <div class="tab-pane fade show active" id="registro" role="tabpanel" aria-labelledby="registro-tab">
        ...
        <div id="displaymessage" class="col-md-12 mt-2 col-sm-12 text-center"></div>
      </div>
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            ?>
                ...
                <textarea class="form-control w-50 txtcomentario" id="txtcomentario" readonly rows="3">
                       <?php
      ...
      <div class="tab-pane fade" id="consulta" role="tabpanel" aria-labelledby="consulta-tab">
        <div class=" col-sm-12 col-md-12 col-lg-12">
          <form class="form-inline" id="formObjetivosPersonal" method="POST" enctype="multipart/form-data" action="
               <?php
            ...
            <div class="form-group mt-4">
              ...
              <input type="text" name="no_reloj" id="relojColaborador" hidden="" value="
                   <?php
...
<script>
  ...
  $('#divTablaObjetivos').load("../loads/objetivos/tablaObjetivosNew", {
    'no_reloj': '<?php echo $no_reloj ?>'
  });
  //  $('#divObjetivosEvaluar').load("../loads/objetivos/tablaObjetivosPendientes", {
  //    'no_reloj': '<?php echo $no_reloj ?>'
  //  });
</script>
</body>
