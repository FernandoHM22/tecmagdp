...
<head>
	...
	<title>Reporte Ficha Talento</title>
				...
				<table id="t_reporteFichaTalento" class="table-compact table-bordered" style="width:100%">
					<thead>
						<tr class="text-center">
							...
							<th width="20%">Líder</th>
							<th width="20%">Fecha Actualización</th>
						</tr>
					</thead>
					<tbody>
						<?php
						$sqlQuery = "SELECT r.no_reloj, r.nombres, r.apellidos, r.correo, r.depto, r.no_reloj_supervisor, r.region, f.fecha_actualizacion , f.reloj_colaborador  from registrogdp r inner join t_fichatalento f on f.reloj_colaborador = r.no_reloj ORDER BY r.nombres ASC" or die(mysqli_error($conn));
						...
						?>
								<tr>
									...
									<td><?php echo $datos['fecha_actualizacion'] ?></td>
								</tr>
						<?php
							}
