...
$consultaedit  = mysqli_query($conn, "SELECT * FROM planeacion_gdp WHERE plan_no_reloj = $reloj");
		...
		<body>
			<form id="form-info" action="../actions/addActions.php" method="POST">
				<div class="modal-body">
					<div class="form-row">
						<input type="text" hidden name="reloj" value="<?php echo $datos['plan_no_reloj'];?>" readonly="true"/>
					</div>
					<div class="form-row">
