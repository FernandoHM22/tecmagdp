...
<body>
	<form id="form-info" action="../actions/addActions.php" method="POST">
		<div class="modal-body">
			...
			<table id="tablaAccionesAdministrador" class="table col-md-12" style="width:100%">
				<tbody>
					<?php 
						...
						while ($datos = mysqli_fetch_assoc($consultaedit)){ ?>
							<tr>
								...
								<td width="20%" class="text-center">
									<a class="agregarAccion" title="Agregar" data-toggle="tooltip" id="<?php echo $datos['id_plan']; ?>"><i class="fas fa-plus"></i></a> 
									<a class="editarAccion" title="Editar" data-toggle="tooltip" id="<?php echo $datos['id_plan']; ?>"><i class="fas fa-pencil-alt"></i></a> 
									<a class="borrarAccion" title="Eliminar" data-toggle="tooltip" id="<?php echo $datos['id_plan']; ?>"><i class="fas fa-trash"></i></a>
								</td>
							</tr>
							<?php 	
						} 
